...
mod tests {
    ...
    fn tools_list_mirrors_the_command_table_exactly() {
        ...
        assert_eq!(names, ["viewport_set", "console_echo", DEFAULT_PERMISSION_TOOL]);
    ...
    fn the_audit_separates_a_withheld_handler_from_a_reachable_one_and_from_no_data() {
        ...
        assert_eq!(served, ["mcp__organon__viewport_set", "mcp__organon__console_echo"]);
    ...
    fn a_served_tool_missing_from_the_model_s_list_is_named() {
        ...
        let audit = server.audit_exposure(&["Bash".to_string(), "mcp__organon__console_echo".into()]);
        assert_eq!(audit.capabilities_offered, ["mcp__organon__console_echo"]);
