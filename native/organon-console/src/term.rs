//! The terminal core (Console #10 Tier 1): a real PTY + the adopted VT state
...
/// absence is why the Console rendered a blank grid there for three rounds of guessing
...
impl TermSession {
    ...
    pub fn spawn(
        ...
        // The IPC namespace must reach the child: an `organon` CLI run INSIDE a Console
...
mod tests {
    ...
    /// a test bug; or (b) the Console's reader not draining ConPTY, a product bug. A trace
