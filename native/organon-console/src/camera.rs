...
//! `console_main.rs` owns the clock, the `World` call and the log line, and maps these onto them.
//!
...
//! gap is recorded in `CONSOLE_ARCHITECTURE.md`'s honesty ledger rather than papered over here.
//!
