//! The harness registry (Console #11 Tier 1): which agent CLIs a tab can run.
//!
...
pub struct HarnessSpec {
    ...
    /// The Console's answer to PRD FR-T5's "each tab in its own working directory".
    ///
...
mod tests {
    ...
    fn the_launch_directory_ascends_to_the_nearest_project_root() {
        let r = conversation_cwd(
            &chat(),
            Platform::Unix,
            Path::new("/Users/example/code/organon/native/organon-console"),
            home_env,
