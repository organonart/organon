//! Platform-dependent process launching (Shell #10 T1 follow-up, 2026-08-08).
//!
...
//! rather than a scattering of `#[cfg(windows)]`.** Shell shipped a terminal that
...
///
/// This is not a convenience wrapper — it is the only way a Windows Shell can host a
