...
- **T14 — the preset ladder. Landed** (`main @ 997cd96` + this change): `nixie`, `foundry`,
  ...
  drops the emission, so both webs are monochrome until that pass reads `emits`. The seed
