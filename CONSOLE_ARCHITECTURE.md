...
two. **8–11 ms median at a 60 Hz consumer, half a frame, and flat across nine times the pixels**,
because staleness is `≈0.55 × min(producer period, poll interval)` and the frame size is not in that
